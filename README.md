...
> **Примечание.** Проверка подписи вебхуков YooKassa сейчас отключена. После вывода проекта в продакшен включите её и убедитесь, что заголовок `X-YooKassa-Signature` передаётся.
